...
INSERT INTO "new_ShiftWish" ("archivedUntil", "comment", "createdAt", "date", "decidedAt", "decidedById", "decisionComment", "deletedAt", "employeeId", "id", "oneTimeBreakMinutes", "oneTimeEnd", "oneTimeStart", "preferredOneTimeLabel", "preferredServiceTemplateId", "status", "tenantId", "updatedAt") SELECT "archivedUntil", "comment", "createdAt", "date", "decidedAt", "decidedById", "decisionComment", "deletedAt", "employeeId", "id", "oneTimeBreakMinutes", "oneTimeEnd", "oneTimeStart", "preferredOneTimeLabel", "preferredServiceTemplateId", "status", "tenantId", "updatedAt" FROM "ShiftWish";
